...
from benchmark.domains.adroit2.quatmath import quat2euler
from benchmark.domains.adroit2 import offline_env
import os

ADD_BONUS_REWARDS = True

class HammerEnvV0(mujoco_env.MujocoEnv, utils.EzPickle, offline_env.OfflineEnv):
    def __init__(self, reward_type="binary", **kwargs):
    ...
    def step(self, a):
        ...
        elif self.reward_type == "dense_original":
            # get to hammer
