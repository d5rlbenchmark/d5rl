...
from benchmark.domains.d4rl2.wrappers.kitchen_rgb_stack import KitchenImageConcatWrapper
...
# from benchmark.domains.d4rl2.data import OfflineMemoryEfficientReplayBuffer2  ###---###
from benchmark.domains.d4rl2.data.kitchen_data_generator import KitchenDataGenerator
...
class OfflineEnv(Wrapper):
    ...
    def q_learning_dataset(self, include_pixels = False, size = 1e5, discount=0.99, debug=False):
        offline_generator = KitchenDataGenerator(self._datasets_urls, self.env, discount=discount)
        ...
        # self._dataset = OfflineMemoryEfficientReplayBuffer2( ###===### ###---###
        #         self.env,
        #         self._datasets_urls,
        #         self.env.observation_space,
        #         self.env.action_space,
