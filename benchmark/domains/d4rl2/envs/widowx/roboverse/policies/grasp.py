...
class Grasp:
    ...
    def __init__(self,
        ...
        self.truncate_zeros = truncate_zeros
        self.reset()
...
class GraspTruncateZeroActions(Grasp):
    """Stops the trajectory after grasp is finished"""

    def __init__(self, env, truncate_zeros=True, **kwargs):
        super(GraspTruncateZeroActions,
              self).__init__(env, truncate_zeros=truncate_zeros, **kwargs)


class GraspTransferSuboptimal(GraspTransfer):

    def __init__(self, env):
        super(GraspTransferSuboptimal, self).__init__(env, suboptimal=True)
