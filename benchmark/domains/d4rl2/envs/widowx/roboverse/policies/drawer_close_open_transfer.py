...
class DrawerCloseOpenTransfer:
    ...
    def __init__(self, env, suboptimal=False):
        ...
        self.bottom_drawer_policy = DrawerOpenTransfer(
            env, suboptimal=self.suboptimal)
...
class DrawerCloseOpenTransferSuboptimal(DrawerCloseOpenTransfer):
    ...
    def __init__(self, env, **kwargs):
        super(DrawerCloseOpenTransferSuboptimal,
              self).__init__(env, suboptimal=True, **kwargs)
